...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`flex flex-col h-full w-64 bg-gray-50 dark:bg-gray-800 p-4 border-r dark:border-gray-700 fixed top-0 left-0 z-40 transition-transform duration-300 ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0 md:flex md:w-64 md:static`}
      >
        <div className="mb-6">
